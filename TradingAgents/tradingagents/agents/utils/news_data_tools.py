...
def search_web(
    query: Annotated[
        str,
        "Search query for company, product, or topic research. Use Chinese queries for Chinese companies (e.g. '可灵 AI 最新进展 2026')",
    ],
    limit: Annotated[int, "Maximum number of results"] = 8,
    engine: Annotated[
        str, "Search engine: 'auto' (Baidu→Bing→Google), 'baidu', 'bing', 'google'"
    ] = "auto",
) -> str:
    """
